...
OS.HardDrive = function (tracks, sectors, blocksPer, blockSize) {
    ...
    this.trackShift = Math.ceil(Math.log(this.sectors) / LOG_OF_2) + // Bits to represent the sector
                      Math.ceil(blocksLog / LOG_OF_2);     // Bits to represent the block
    this.sectorShift = Math.ceil(blocksLog / LOG_OF_2);    // Bits to represent the block
};
